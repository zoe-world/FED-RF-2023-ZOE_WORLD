...
// 2. 감독
jh_obj.director = "스파이크 존즈";

// 3. 배우
jh_obj.actor = "호아킨 피닉스";

// 4. 장르
jh_obj.genre = "드라마/로맨스";

// 5. 관람가
jh_obj.ratings = "15세 관람가";

// 6. 예고편
jh_obj.trailer = function () {
    console.log("예고편:", "pa54j-65rGQ");
    // 플레이어함수 호출!
...
// 오브젝트 형만 만들고 객체내용은 아래에서!
// 1. 영화제목
naewoo_Obj.title = "클래식";
// 2. 감독
naewoo_Obj.director = "곽재용";
// 3. 배우
naewoo_Obj.actor = "조승우,손예진";
// 4. 장르
naewoo_Obj.genre = "멜로/로맨스";
// 5. 관람가
naewoo_Obj.ratings = "12세";
// 6. 예고편
