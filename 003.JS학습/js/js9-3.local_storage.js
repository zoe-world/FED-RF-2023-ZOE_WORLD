...
function localSFn(){
    ...
    if(btxt == '처음'){
        ...
        // 로컬 스토리지 전체지우기: 해당 url로 관리되는 로컬쓰(스토리지)를 모두 지움!
        // -> localStorage.clear(키명);
        localStorage.clear('lname');
        // 개별 로컬쓰로 지우는 방법은 localStorage.removeItem(키명)
    } /////// else if : 전체삭제//////
    else if(btxt == '보여줘'){
    ...
    // - 객체를 생성하여 로컬 스토리지에 넣기//////
        ...
        // localStorage에 minfo의 값이 없으면 makeObj 함수를 호출해라
...
function sessionSFn(){
    ...
    if(btxt == '처음'){
        ...
        // 세션 스토리지 전체지우기: 해당 url로 관리되는 세션쓰(스토리지)를 모두 지움!
        // -> sessionStorage.clear(키명);
        sessionStorage.clear('lname');
        // 개별 세션쓰로 지우는 방법은 sessionStorage.removeItem(키명)
    } /////// else if : 전체삭제//////
    else if(btxt == '보여줘'){
