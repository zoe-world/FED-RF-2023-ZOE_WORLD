...
// but!! 파일명이 겹쳐지므로 이것을 커스터 마이징 하여
// 변경하게 되면, 자동으로 폴더생성이 안되므로,
// 우리가 uploads라는 폴더를 직접 생성해줘야함
// 배포시 이 폴더가 생기도록 SPA 개발폴더의 public아래에 
// uploads 폴더를 만들어준다

// 파일명을 내가 원하는 원래이름으로 들어가도록 변경한다!
// 멀터 스토리지의 저장소를 사용함!@
const storage = multer.diskStorage({
    // 폴더경로를 여기 설정함(dest설정은 지워준다!)
...
// 두번째 항목은 전송종류를 설정 : 파일전송과 관련된 설정임 'file'
// 세번째 항목은 내부전달변수인 요청, 응답에 대한 함수
