...
// (1-3) 요소 출력하기 : 생성된 루트에 render() 메서드를 붙여서 사용
root1.render(myEle1);
...
// 출력형식 :
// <li>배우명 : 영화명</li>
// 배열변수.map 사용하자! -> 여기서도 맵쬬잉 인가?
// js amp()과는 다른 별도의 출력처리가 이루어짐
// 결론: map()만 사용하여 바로 출력 가능
...
/***************************************************** 
    ...
    xml 문법을 기반하기 때문에 넣어줘야함!
*****************************************************/

// 6. 홀로태그 출력해보기
const myEle6 = <input type="" value="홀로태그는 스스로 닫아라!" />
...
const myEle7 = <h1 className="myclass">className 속성으로 class를 셋팅한다!</h1>
