...
function MainCategory() {
  ...
  return (
    <React.Fragment>
      ...
      <ItemList cname={selData["경로"] } tit={selData["경로"]}/>
    </React.Fragment>
  );
} ///////// MainCategory 컴포넌트 /////////////
